...
#-----------------------------------------------------------------------------------------------
str_semana = 'Semana: 28 de agosto hasta 3 de septiembre de 2017'

#-----------------------------------------------------------------------------------------------
# Parametros necesarios para hacer el reporte
#-----------------------------------------------------------------------------------------------
path_elem = '/home/atlas/informe_hidromet/20170904/'
path_reps = '/home/atlas/informe_hidromet/20170904/informe/'
...
par1 = Paragraph (u'Imagen de reflectividad del radar a las 04:06 del 31 de agosto, \
                    correspondiente al evento de precipitación con número de informe \
                    1198, en el cual se observa que durante el evento las precipitaciones \
                    alcanzaron a cubrir el centro y sur del Valle de Aburrá con \
                    intensidades predominantemente bajas y un núcleo de intensidad \
                    media que alcanzó a cubrir pare del centro y sur del Valle. \
                    Este evento de precipitación fue uno de los más relevantes de \
                    la semana.', style1)
par1.wrap(515, 890)
...
par1 = Paragraph (u'A escala regional, los acumulados semanales de precipitación \
                    presentan acumulados altos en oriente, suroeste y bajo Cauca \
                    antioqueño. Por su parte, a escala local, en el Valle de Aburrá \
                    se registraron acumulados máximos cercanos a 110 mm en el \
                    sur-occidente del Valle y norte de Barbosa, pero en promedio \
                    en el valle los acumulados fueron menores a 80 mm, debido a \
                    que los eventos que contribuyeron más al estos acumuados se \
                    concentraron en la ladera occidental del Valle y el norte de \
                    Barbosa.', style1)
par1.wrap(390, 890)
...
data = [['Informe','Inicio','Acumulado','Municipio','Intensidad','Municipio'],
        [1197,'2017-08-29' , 32.09,  u'Barbosa',     83.88,  u'Medellín'     ],
        [1198,'2017-08-30' , 35.18,  u'Medellín',    88.00,  u'Medellín'    ],
        [1199,'2017-08-30' , 16.21,  u'Medellín',    63.60,  u'Medellín'    ],
        [1200,'2017-09-03' , 12.70,  u'La Estrella',103.63,  u'Medellín'    ]]
...
par1 = Paragraph (u'Durante esta semana se registraron cuatro eventos de precipitación \
                    ...
                    es de resaltar que ningún evento superó el umbral de 45 mm ', style1)
par1.wrap(650, 890)
...
pdf_rep2.drawImage(path_elem+'descargas_elec/MapaScatter_201708280000.png', \
                780., 595., 360., 360., mask = 'auto')
pdf_rep2.drawImage(path_elem+'descargas_elec/20170903.png', \
                1200., 595., 455., 360., mask = 'auto')
style1 = ParagraphStyle(name='Justify', alignment=TA_JUSTIFY, fontName='Avenir', fontSize=20,\
                       leading = 24)
par1 = Paragraph (u'En esta última semana se presentaron en total 267 descargas \
                    eléctricas tipo nube-tierra al interior del Valle de Aburrá. \
                    La mayoría de estas descargas se registraron en el municipio \
                    de Medellín, en donde la cifra ascendió a 166 descargas. La \
                    mayor cantidad de descargas se presentaron sobre la ladera \
                    occidental del Valle. Se presentó una mayor actividad eléctrica \
                    en asociación a una tormenta  que tuvo lugar el lunes 28, en \
                    donde se presentaron en total 112 descargas eléctricas tipo \
                    nube-tierra, éstas en su mayoría en el municipio de Medellín.', style1)
par1.wrap(660., 890.)
...
pdf_rep2.drawImage(path_elem+'vientos_temp/promedio_viento_temperatura_2017-08-28_2017-09-03.png', \
...
pdf_rep2.drawImage(path_elem+'vientos_temp/maximo_viento_temperatura_2017-08-28_2017-09-03.png', \
...
output.write(file(path_reps+'HIDROMET_2017-09-04.pdf','w'))
