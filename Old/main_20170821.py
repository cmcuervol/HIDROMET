...
par1 = Paragraph (u'Imagen de reflectividad del radar a las 20:48 del 16 de agosto, \
                    correspondiente al evento de precipitación con número de informe \
                    1185, en el cual se observa que durante el evento las precipitaciones \
                    alcanzaron a cubrir gran parte del centro y sur del Valle de \
                    Aburrá con intensidades predominantemente bajas y algunos \
                    núcleos de intensidades altas.', style1)
par1.wrap(515, 890)
...
par1 = Paragraph (u'A escala regional, los acumulados semanales de precipitación \
                    presentan valores altos en oriente oriente, norte y suroeste \
                    antioqueño. Por su parte, a escala local, en el Valle de Aburrá \
                    se registraron acumulados máximos superiores a 110 mm, pero \
                    sólo en el norte de Barbosa, en el resto del Valle, los acumulados \
                    fueron menores a 80 mmm, debido a que los los eventos ocurridos \
                    durante esta semana se concentraron principalmente en el norte \
                    del Valle.', style1)
par1.wrap(390, 890)
...
data = [['Informe','Inicio','Acumulado','Municipio','Intensidad','Municipio'],
        [1184,'2017-08-15' ,26.87, u'Barbosa',       34.32, u'Caldas'    ],
        [1185,'2017-08-16' ,58.67, u'Medellín',     121.92, u'Caldas'    ],
        [1186,'2017-08-18' ,31.24, u'Medellín',      88.39, u'Medellín'  ],
        [1188,'2017-08-19' ,21.73, u'Medellín',      88.24, u'Medellín'  ],
        [1189,'2017-08-13' ,29.98, u'Medellín',      97.54, u'Envigado'  ]]
...
pdf_rep2.drawImage(path_elem+'descargas_elec/MapaScatter_201708140000.png', \
                780., 595., 360., 360., mask = 'auto')
pdf_rep2.drawImage(path_elem+'descargas_elec/20170820.png', \
                1200., 595., 455., 360., mask = 'auto')
style1 = ParagraphStyle(name='Justify', alignment=TA_JUSTIFY, fontName='Avenir', fontSize=20,\
                       leading = 24)
par1 = Paragraph (u'En resumen, en esta última semana se presentaron en total 417 \
                    descargas eléctricas tipo nube-tierra al interior del Valle \
                    de Aburrá. La mayoría de estas descargas se registraron en \
                    los municipios de Medellín y Barbosa, en donde la cifra ascendió \
                    a 173 y 82 descargas respectivamente y se registraron la mayoría \
                    de estas durante el evento de precipitaición del 16 de agosto. \
                    Se presentó una mayor actividad eléctrica en asociación a una \
                    tormenta  que tuvo lugar el miércoles 16, en donde la máxima \
                    densidad de las descargas se localizó en el centro de Medellín. \
                    El número total de descargas tipo nube-tierra de este día fue \
                    de 187.', style1)
par1.wrap(660., 890.)
...
pdf_rep2.drawImage(path_elem+'vientos_temp/promedio_viento_temperatura_2017-08-14_2017-08-20.png', \
...
par2 = Paragraph (u'En el mapa de la izqquierda es posible observar que la dirección \
                    ...
                    un valor de 4 km/h. Por su parte las temperaturas promedio \
                    registaradas por las estaciones en la base del Valle están \
                    alrededor de los 21ºC y la menor temperatura promedio fue \
                    registrada por la estación Santa Elena (11ºC).', style1)

par2.wrap(400, 890)
par2.drawOn(pdf_rep2, 430., 160)

pdf_rep2.drawImage(path_elem+'vientos_temp/maximo_viento_temperatura_2017-08-14_2017-08-20.png', \
...
par3 = Paragraph (u'La dirección de los vientos máximos registrados durante la \
                    ...
                    destacable la magnitud máxima registrada  por la estación \
                    ubicada en el AMVA (40 km/h). Por su parte, las temperaturas \
                    máximas registradas en la base del Valle estuvieron entre los \
                    29 y 30ºC, mientras que las laderas variaron entre 24 y 27 ºC. \
                    El máximo registrado por la estación Santa Elena fue de 16ºC ', style1)
par3.wrap(360, 890)
...
pdf_rep5.drawImage(path_elem+'nivel_hidro/20170814to20170820.png', \
...
par5 = Paragraph (u'Durante la semana se presentaron seis eventos de lluvia de \
                    especial consideración, el más importante de ellos entre el \
                    16 y 17 de agosto, donde estaciones como La Presidenta, y el \
                    Colegio Campestre El Encanto reportaron niveles superiores al \
                    segundo nivel de alerta, en el caso de La Presidenta el nivel \
                    alcanzó a llegar al cuarto nivel de alerta, sin presentar \
                    mayores afectacciones para la comunidad. La figura de la \
                    izquierda corresponede a la estación del Parque 3 aguas en \
                    Caldas. En esta se puede observar en la parte superior izquierda, \
                    la distribución de la lluvia acumulada en la cuenca, calculada \
                    a partir de datos del radar meteorológico. En el recuadro \
                    ubicado en la parte superior derecha se ubican las curvas de \
                    duración, estas representan la probabilidad de excedencia de \
                    determinado nivel; la línea roja punteada es la curva de duración \
                    de los últimos 7 días, la línea punteada azul es la curva de \
                    duración del último mes y la curva en negro sólido es la curva \
                    generada apartir de datos históricos.', style1)
par5.wrap(1620, 300)
...
pdf_rep6.drawImage(path_elem+'incendios_vul/reporte_semanal_2017-08-17.png', \
...
par6 = Paragraph (u'Con el fin de mostrar a diario la vulnerabilidad a incendios \
                    ...
                    el Valle de Aburrá del día mas crítico de la semana (2017-08-17). \
                    Además se presenta la ubicación de 5 incendios reportados \
                    durante la semana, de los cuales dos se presentaron al suroccidente \
                    de Medellín, dos al noroccidente y uno en limites entre Medellín \
                    e Itagui. En esta semana se observa disminución en la vulnerabilidad \
                    de incendios, en especial para el norte del Valle de Aburrá. \
                    Dichas disminuciones estan asociadas al aumento de los acumulados \
                    de precipitación.', style1)
...
output.write(file(path_reps+'HIDROMET_2017-08-21.pdf','w'))
